...
(update fitur 0.5.1 : 
- tambahkan fitur cek server di web interaktif agar lihat data server tidak harus buka teks editor (vsc/antigravity)
fixes : 
- analisa mengapa untuk masukan file harus 2 kali baru file nya teregister di web) selesai.